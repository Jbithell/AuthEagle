...
$CONSUMER_KEY='yukL96J7NiVFTm7LgRz4UcgWJ';
$CONSUMER_SECRET='m5oMqOpc1RmWDmlDASY3dmA34MOPUNvLYtHxA3AET7aHNbEKjo';
$OAUTH_CALLBACK='https://oauth.autheagle.com/dash/twitter/oauth.php';
...
if(isset($_GET['oauth_token']))
{
	...
	if($access_token)
	{
			...
			if($content && isset($content->screen_name) && isset($content->name))
			{
				...
				echo $_SESSION['name'] . $_SESSION['image'] . $_SESSION['twitter_id'];
