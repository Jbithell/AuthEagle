<?php
if (!isset($_GET['beta'])) {
	$base = '<base href="' . 'https://' . $_SERVER['SERVER_NAME'] . '/countdownsite/" />';
	require_once 'countdownsite/index.php';
	die();
}
?>
<!DOCTYPE html>
	...
	<body>
		...
		<div class="footer">
			<div class="container">
				<div class="row">
					...
					<div class="col-footer col-md-4 col-xs-6">
						...
						<p class="contact-us-details">
							<!--<b>Address:</b> London, United Kingdom<br/>-->
							<b>Phone:</b> +44 (0) 238 000 0329<br/>
							<b>Email:</b> <a href="mailto:support@autheagle.com">support@autheagle.com</a>
						</p>
					</div>
					<div class="col-footer col-md-2 col-xs-6">
						<h3>Stay Connected</h3>
						<ul class="footer-stay-connected no-list-style">
							<li><a href="https://www.facebook.com/autheagle" class="facebook"></a></li>
							<li><a href="https://twitter.com/autheagle" class="twitter"></a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="footer-copyright">&copy;<?php echo date('Y'); ?> AuthEagle. All rights reserved.</div>
					</div>
				</div>
			</div>
		</div>
