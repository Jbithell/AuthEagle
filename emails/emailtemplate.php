<?php
function outputemail($htmlcontent, $id, $disablelinks = false) {
	return '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Message from AuthEagle</title>
		...
		<meta property="og:title" content="A ,essage from AuthEagle" />
	</head>
		...
		<center class="wrapper" style="display: table;table-layout: fixed;width: 100%;min-width: 620px;-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;background-color: #fbfbfb">
			...
			<tbody><tr>
				...
				<table style="border-collapse: collapse;border-spacing: 0;width: 602px">
					<tbody><tr>
					<td class="title" style="padding: 0;vertical-align: top;padding-top: 10px;padding-bottom: 12px;font-size: 12px;line-height: 21px;text-align: left;color: #999;font-family: Georgia,serif">&#10004;Official Message from AuthEagle' . (!$disablelinks ? ' - <a href="//mailings.autheagle.com?id=' . urlencode($id) . '#verify">Verify</a>' : null) . '</td>
					<td class="webversion" style="padding: 0;vertical-align: top;padding-top: 10px;padding-bottom: 12px;font-size: 12px;line-height: 21px;text-align: right;width: 300px;color: #999;font-family: Georgia,serif">
						' . (!$disablelinks ? '<a href="//mailings.autheagle.com?id=' . urlencode($id) . '"><webversion style="font-weight:bold;text-decoration:none;">View in Browser</webversion></a>' : '<webversion style="font-weight:bold;text-decoration:none;">Browser View</webversion>') . '
					</td>
					</tr>
				</tbody></table>
				</td>
			...
			<tr><td class="logo" style="padding: 32px 0;vertical-align: top;mso-line-height-rule: at-least"><div class="logo-center" style="font-size: 26px;font-weight: 700;letter-spacing: -0.02em;line-height: 32px;color: #41637e;font-family: sans-serif;text-align: center" align="center" id="emb-email-header"><a style="text-decoration: none;transition: all .2s;color: #41637e" ' . (!$disablelinks ? 'href="http://www.autheagle.com"' : null) . '><img style="border: 0;-ms-interpolation-mode: bicubic;display: block;Margin-left: auto;Margin-right: auto;max-width: 283px" src="https://mailings.autheagle.com/images/logo.png" alt="AuthEagle Logo" width="189" height="189" /></a></div></td></tr>
			</tbody></table>
				...
				<table style="border-collapse: collapse;border-spacing: 0">
					...
					<td class="address" style="padding: 0;vertical-align: top;width: 400px;padding-top: 32px;padding-bottom: 64px">
						...
						<tbody><tr>
							...
							<div>This is an official message from AuthEagle. Messages from AuthEagle will always carry the "Official Message from AuthEagle" banner - If you receive messages purporting to come from AuthEagle not bearing the banner please contact support@autheagle.com immediately, forwarding the message you have received.</div>
							</td>
						</tr>
						</tbody></table>
					</td>
					<td class="subscription" style="padding: 0;vertical-align: top;width: 200px;padding-top: 32px;padding-bottom: 64px">
						<table class="contents" style="border-collapse: collapse;border-spacing: 0;table-layout: fixed;width: 100%">
						<tbody><tr>
							<td class="padded" style="padding: 0;vertical-align: top;padding-left: 10px;padding-right: 0;word-break: break-word;word-wrap: break-word;font-size: 12px;line-height: 20px;color: #999;font-family: Georgia,serif;text-align: right">
								<span class="block"><unsubscribe style="text-decoration:none;">Any questions or want to unsubscribe&#63; Forward this E-Mail to <a href="mailto:support@autheagle.com">support@autheagle.com</a> or call us on <a href="tel:00442380000329">+44 (0) 238 0000 329</a></unsubscribe></span>
